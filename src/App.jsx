...
import StudentEnrolled from "./pages/studentlist/StudentEnrolled";
import FullInformation from "./pages/studentlist/FullInformation";
export const App = () => {
      ...
      <Router>
        ...
        {loading ? (
          ...
          <Routes>
            ...
            <Route path="/studentlist" element={<StudentEnrolled />} />
            <Route path="/fullinfo" element={<FullInformation />} />
            {/* Private Routes */}
